...
inline void list_add(struct list *entry, struct list *head)
{
...
inline void list_add_end(struct list *entry, struct list *head)
{
...
inline void list_init(struct list *head)
{
	head->next = head;
	head->prev = head;
}
