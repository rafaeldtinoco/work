...
void int_commit_sys(struct int_sys *sys, u64 updtime)
{
...
void int_is_cpu_ded(struct int_cpu *cpu, int weight)
{
...
void int_commit_cpu(struct int_cpu *cpu)
{
	struct int_sys *parent = cpu->parent;
...
void int_update_sys_start(struct int_sys *sys)
{
...
void int_update_cpu_start(struct int_cpu *cpu)
{
...
void int_update_sys_end(struct int_sys *sys)
{
...
void int_update_cpu_end(struct int_sys *sys)
{
...
void us_cpu_set(struct int_cpu *cpu, u64 value)
{
	cpu->current->cpu_time_us = value;
}
void us_mgm_set(struct int_cpu *cpu, u64 value)
{
	cpu->current->mgm_time_us = value;
}
void us_online_set(struct int_cpu *cpu, u64 value)
{
...
inline u64 dis_tod(struct int_sys *sys)
{
	if(sys->dedicated)
		return sys->corrtime;
	return sys->updtime;
...
inline u64 dis_tod_old(struct int_sys *sys)
{
	if(sys->dedicated)
...
inline u64 dis_tod_delta(struct int_sys *sys)
{
...
inline u64 dis_cpu_cur(struct int_cpu *cpu)
{
...
inline u64 dis_cpu_cur_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_cpu_prev(struct int_cpu *cpu)
{
	if(cpu->parent->dedicated)
...
inline u64 dis_cpu_prev_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_cpu_delta(struct int_cpu *cpu)
{
	return (dis_cpu_cur(cpu) - dis_cpu_prev(cpu));
}

inline u64 dis_cpu_delta_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_cpu_ratio(struct int_cpu *cpu)
{
	float res;
...
inline float dis_cpu_ratio_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_cpu_util(struct int_cpu *cpu)
{
	float res;
...
inline float dis_cpu_util_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_mgm_cur(struct int_cpu *cpu)
{
	if(cpu->parent->dedicated)
...
inline u64 dis_mgm_cur_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_mgm_prev(struct int_cpu *cpu)
{
	if(cpu->parent->dedicated)
...
inline u64 dis_mgm_prev_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_mgm_delta(struct int_cpu *cpu)
{
	return (dis_mgm_cur(cpu) - dis_mgm_prev(cpu));
}

inline u64 dis_mgm_delta_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_mgm_ratio(struct int_cpu *cpu)
{
	float res;
...
inline float dis_mgm_ratio_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_mgm_util(struct int_cpu *cpu)
{
	float res;
...
inline float dis_mgm_util_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_total_cur(struct int_cpu *cpu)
{
	return (dis_cpu_cur(cpu) + dis_mgm_cur(cpu));
}

inline u64 dis_total_cur_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_total_prev(struct int_cpu *cpu)
{
	return (dis_cpu_prev(cpu) + dis_mgm_prev(cpu));
}

inline u64 dis_total_prev_sum(struct int_sys *sys)
{
	u64 sum = 0;
	struct int_cpu *cpu;
...
inline u64 dis_total_delta(struct int_cpu *cpu)
{
	return (dis_total_cur(cpu) - dis_total_prev(cpu));
}

inline u64 dis_total_delta_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_total_ratio(struct int_cpu *cpu)
{
	float res;
...
inline float dis_total_ratio_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
...
inline float dis_total_util(struct int_cpu *cpu)
{
	float res;
...
inline float dis_total_util_sum(struct int_sys *sys)
{
	float sum = 0;
	struct int_cpu *cpu;
